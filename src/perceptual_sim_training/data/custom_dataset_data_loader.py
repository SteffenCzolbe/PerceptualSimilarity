...
def CreateDataset(dataroots,dataset_mode='2afc',load_size=64,):
    ...
    if dataset_mode=='2afc': # human judgements
        ...
        from data.jnd_dataset import JNDDataset
        dataset = JNDDataset()
    else:
...
class CustomDatasetDataLoader(BaseDataLoader):
    ...
    def initialize(self, datafolders, dataroot='./dataset',dataset_mode='2afc',load_size=64,batch_size=1,serial_batches=True, nThreads=1, use_gpu=False):
