...
python ./train.py --use_gpu --model watson --net vgg --colorspace Gray --name gray_watson_vgg_trial0 --trainloss ranked --nepoch 10 --nepoch_decay 10 --lr 0.0002
...
python ./train.py --use_gpu --model watson --net vgg --colorspace RGB --name rgb_watson_vgg_trial0 --trainloss ranked --nepoch 10 --nepoch_decay 10 --lr 0.0002
